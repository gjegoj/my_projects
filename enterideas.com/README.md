...
2) Данные были предварительно обработаны, очищенны от не валидных картинок, разложены по репозитория, аугментированны и, в конечном итоге, сведенны в генератор данных.
