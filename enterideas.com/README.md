...
2) В работе использовалась заранее предобученная модель Xception и в процессе дообученная для получаения более высокой точности (91%).
3) Модель можно улучшить поискоим более оптимальных гиперпараметров: 
